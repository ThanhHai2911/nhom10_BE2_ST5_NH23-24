...
class HomeController extends Controller
{
    public function index($page = "index"){
        ...
        return view($page,compact('product','data_category','data_latestproduct','latestproduct','data_product','product_cart'));
    }
    ...
    public function categoryproducts($categoryproducts){
        ...
        return view('category-product',compact('product','data_category', 'category','product_cart'));
    }
